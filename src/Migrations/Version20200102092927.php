 ...
 */
final class Version20200102092927 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contacts_request (id INT AUTO_INCREMENT NOT NULL, fk_sending_user_id INT NOT NULL, fk_receiving_user_id INT NOT NULL, name VARCHAR(255) NOT NULL, number INT NOT NULL, UNIQUE INDEX UNIQ_B13F83C2A4DF1A48 (fk_sending_user_id), UNIQUE INDEX UNIQ_B13F83C287D5D68E (fk_receiving_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
